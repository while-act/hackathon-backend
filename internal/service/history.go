...
type HistoryPostgres interface {
	...
	CreateHistory(ctx context.Context, h *dto.History, busactId string, userId int) error
}
...
func (i *HistoryService) CreateHistory(h *dto.History, busactId string, id int) error {
